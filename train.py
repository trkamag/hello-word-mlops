...
def parse_args():
    ...
    p.add_argument("--n-estimators", type=int, default=20, help="RandomForest n_estimators (default: 50)")
    p.add_argument("--max-depth", type=int, default=10, help="RandomForest max_depth (default: 5)")
